<script lang="ts">
  import { configMessages, ipDataStore } from "lib/entities/Store";
  ...
  let menuItems: MenuItem[] = [
    new MenuItem("Remove", "delete", () => {
      ...
      const configMessageIndex = Array.prototype.indexOf.call(
      ...
      <ul class="responsive">
        {#each menuItems as item}
          <button
            ...
            class="small-blur border transparent small-round"
...
<svelte:window on:contextmenu={onContextMenu} on:click={onPageClick} />
