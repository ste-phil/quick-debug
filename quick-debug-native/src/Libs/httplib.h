...
#define USE_IF2IP
    ...
    inline std::pair<std::string, std::string>
        ...
        auto field = "Basic " + detail::EncodeBase64(username + ":" + password);
        auto key = is_proxy ? "Proxy-Authorization" : "Authorization";
    ...
    inline socket_t ClientImpl::create_client_socket(Error& error) const {
        ...
        return detail::create_client_socket(
            host_, ip, m_port, address_family_, tcp_nodelay_, socket_options_,
    ...
    inline bool ClientImpl::redirect(Request& req, Response& res, Error& error) {
        ...
        if (next_scheme == scheme && next_host == host_ && next_port == m_port) {
    ...
    inline int ClientImpl::port() const { return m_port; }
